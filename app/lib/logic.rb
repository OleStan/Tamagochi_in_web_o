...
(+2 stomach and +1 hp)'
      ...
      when 'interest'
        ...
        if reg.cookies['stomach'].to_i.to_i.positive?
          response.set_cookie('stomach', reg.cookies['stomach'].to_i.to_i - 1)
        end
        response.set_cookie('sleepiness', reg.cookies['sleepiness'].to_i.to_i + 1)
        response.set_cookie('notification_action',
                            "You play with #{pname}")
      ...
      when 'cleaning'
        ...
        if reg.cookies['interest'].to_i.to_i.positive?
      ...
      when 'looking'
        ...
        if reg.cookies['intelect'].to_i.to_i.positive?
      ...
      check_status = lambda { |reg, item, minimal, adress, text|
      ...
      response.set_cookie('notification_event', $notification_event)
